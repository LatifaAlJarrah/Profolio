...
const TemplatesPage = () => {
  ...
  return (
    <div className="py-8 text-center px-10 lg:px-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        {templates.map((item, index) => {
          return (
            <div key={index}>
              <div
                className="relative rounded-md shadow-md flex flex-col items-center justify-center overflow-hidden cursor-pointer h-60 lg:h-96"
                onClick={() =>
