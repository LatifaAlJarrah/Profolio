...
//   return (
//     <section className="px-10 py-8 bg-black text-white mx-auto">
...
//                 <h3 className="text-lg lg:text-2xl">{item.name}</h3>
//                 <div className="border border-yellow w-full lg:w-[500px]"></div>
//                 <span className="text-yellow font-bold text-3xl">
//                   {item.price}
//                 </span>
//               </div>
//               <p className="text-charcoalGray texl-base lg:text-xl mt-1 mx-2">
//                 {item.description}
//               </p>
//             </div>
//           </div>
