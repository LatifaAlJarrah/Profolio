...
// تعريف الـ Props بناءً على البيانات المطلوبة
...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <nav
      className={`${isControlPage ? "" : "fixed top-0 left-0 right-0"} border border-[#33353F] z-10 bg-[#121212] bg-opacity-100 px-20`}
