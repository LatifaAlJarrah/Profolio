    ...
    <section className={`${roboto.className} py-16 mx-auto`}>
      <div className="grid grid-cols-12 items-center gap-8">
        ...
        <div className="col-span-5 space-y-6">
          ...
          <button className="bg-navyBlue text-white py-3 px-6 rounded-lg font-medium hover:bg-opacity-80 text-2xl">
        ...
        <div className="col-span-2 flex justify-center">
          <div className="relative w-72 h-96 overflow-hidden rounded-full">
            {/* Inner Border */}
