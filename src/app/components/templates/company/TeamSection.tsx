...
//   return (
//     <div className="py-10 bg-[#FAFAFA] px-20">
...
//             <div className="bg-white p-5 rounded-[200px] shadow-lg text-center w-60 h-96">
//               <Image
//                 src={member.img}
//                 alt={member.name}
//                 width={150}
...
//               <div className="flex justify-center gap-3 text-gray-600 mt-28">
//                 <FontAwesomeIcon icon={faInstagram} className="w-8 h-8" />
//                 <FontAwesomeIcon icon={faBehance} className="w-8 h-8" />
