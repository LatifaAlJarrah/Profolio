...
// src/components/controltemplate/Navbar.tsx
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faArrowLeft } from "@fortawesome/free-solid-svg-icons";
import Link from "next/link";
import Image from "next/image";
  ...
  return (
    <nav className="flex items-center justify-between py-2 px-8 bg-gray-100">
      ...
      <div className="flex items-center space-x-2">
        <button
          onClick={onPreview}
          className="text-primary bg-transparent w-[123px] h-[35px] border border-primary rounded-lg text-lg border-none hover:bg-primary hover:text-white"
        >
