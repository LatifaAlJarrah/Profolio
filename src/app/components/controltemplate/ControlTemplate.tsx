...
// // // //   buttonColor: "#58ADEB",
// // // //   fontFamily: "Roboto",
// // // //   logoName: "Dentelle", // إضافة logoName لتعديل نص الـ DentistLogo
// // // //   navLinks: [
// // // //     // إضافة navLinks لتعديل الروابط في NavbarList
// // // //     { name: "Home", link: "#home" },
...
// // // //             onTestimonialChange={handleTestimonialChange}
// // // //             onBlogImageChange={handleBlogImageChange}
// // // //             onNavLinkChange={handleNavLinkChange} // تمرير دالة لتعديل الروابط
// // // //             onSave={saveTemplateData}
// // // //             onLoad={loadTemplateData}
// // // //             onReset={resetTemplateData}
// // // //           />
...
// // //           {selectedTemplate?.Component ? (
// // //             <selectedTemplate.Component
// // //               key={`${templateData.logoName}-${JSON.stringify(
// // //                 templateData.navLinks
// // //               )}`} // إضافة key لإجبار إعادة الـ render
// // //               {...templateData}
// // //             />
// // //           ) : (
// // //             <p>Template not found</p>
...
// //   // دالة لتحديث السلايدر في Portfolio
// //   const handlePortfolioSlideChange = (index: number, field: string, value: string) => {
// //     setTemplateData((prev) => {
// //       const updatedSlides = [...prev.portfolioSlides];
// //       updatedSlides[index] = { ...updatedSlides[index], [field]: value };
// //       return { ...prev, portfolioSlides: updatedSlides };
...
// //           {selectedTemplate?.Component ? (
// //             <selectedTemplate.Component
// //               key={`${templateData.logoName}-${JSON.stringify(templateData.navLinks)}-${templateData.contactBookingText}-${templateData.instagramName}-${templateData.instagramLink}-${templateData.facebookName}-${templateData.facebookLink}-${templateData.contactPhone}-${templateData.contactEmail}-${templateData.contactLocation}`}
// //               {...templateData}
// //             />
// //           ) : (
// //             <p>Template not found</p>
...
//           {selectedTemplate?.Component ? (
//             <selectedTemplate.Component
//               key={renderKey} // استخدام الـ counter كـ key
//               {...templateData}
//             />
//           ) : (
//             <p>Template not found</p>
...
// Arial و Times New Roman مش محتاجين تحميل لأنهم fonts افتراضية
...
const defaultTemplateData = {
  ...
  headerDescription:
    "Contact us now to book your appointment and experience our premium service.",
  headerImage: "/assets/images/dentist/backgroundDent.png",
  logoIcon: "/assets/images/dentist/logo.png",
  headerTextColor: "#FFFFFF",
  aboutTitle: "ABOUT ME",
  aboutDoctorName: "Dr. Sarah Williams",
  aboutDescription:
        ...
        <MainEditor>
          {selectedTemplate?.Component ? (
            <selectedTemplate.Component
              key={renderKey}
              {...templateData}
              fontFamilyClass={getFontClassName()} // تمرير className بتاع الـ font
            />
          ) : (
            <p>Template not found</p>
          )}
