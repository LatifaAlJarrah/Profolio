...
interface DeveloperAchievementsSectionProps {
...
const DeveloperAchievementsSection: React.FC<
  DeveloperAchievementsSectionProps
> = ({
  templateData,
  onAchievementsChange,
  onAddAchievement,
...
export default DeveloperAchievementsSection;
