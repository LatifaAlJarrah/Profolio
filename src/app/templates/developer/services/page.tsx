...
// const Services = ({ developerServices }: Services) => {
...
const ServicesComponent = ({ developerServices }: Services) => {
  const defaultServices = [
    {
      num: "01",
      title: "Web Development",
...
export default function ServicesPage() {
  ...
  return <ServicesComponent developerServices={developerServices} />;
}
